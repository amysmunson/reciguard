  ...
  <View style={{ flex: 1, backgroundColor: colors.background }}>
    ...
    <ScrollView contentContainerStyle={styles.screen_policyPad}>
      ...
      <Text style={styles.policy_body}>
        ...
        folders, notes, and allergy information so they are available when you sign in, and
        to power features such as allergy warnings and linking with friends. We do not sell
